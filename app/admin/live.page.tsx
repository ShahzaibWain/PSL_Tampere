          ...
          <div className="w-full max-w-4xl rounded-[2.5rem] border border-amber-300/35 bg-[linear-gradient(135deg,_rgba(251,191,36,0.24),_rgba(15,23,42,0.94))] p-8 text-center shadow-[0_0_80px_rgba(251,191,36,0.18)] backdrop-blur">
            ...
            <div className="mt-6 flex flex-col items-center gap-5">
              ...
              <div>
                ...
                <p className="mt-2 text-6xl font-extrabold text-amber-200">{soldCelebration.name}</p>
              ...
              <div className="rounded-[1.75rem] border border-white/10 bg-white/10 px-8 py-5">
                ...
                <p className="mt-2 text-5xl font-extrabold text-emerald-300">
              ...
              <div className="grid gap-8 md:grid-cols-2">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-6xl font-extrabold text-emerald-300">
                  ...
                  >
                    ...
                    {leadingTeam ? (
                      <div className="mt-3 flex items-center gap-4">
                        ...
                        />
                        <div>
                          <p className="text-4xl font-extrabold">{leadingTeam.name}</p>
                      ...
                      <p className="mt-2 text-2xl font-bold">No bids yet</p>
                    )}
                  </div>
                </div>
              </div>
                    ...
                    >
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                          ...
                          />
                          <div>
                            <p className="text-2xl font-bold">{bid.teams?.name || 'Unknown Team'}</p>
                    ...
                    >
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-slate-900 font-bold">
                            {index + 1}
                          </div>
                  ...
                  <div className="mt-6 space-y-4">
                    {soldPlayers.map((player) => (
                      ...
                      >
                        <div className="flex items-center justify-between gap-4">
                          <div className="flex items-center gap-4">
                            <div className="h-14 w-14 overflow-hidden rounded-2xl bg-white flex items-center justify-center">
                              {player.image_url ? (
                                <img
